...
@media screen and (max-width: 768px) {
			...
			<div class="slider">
				<div>
					<ul>
                       ...
                       <a href="addadmin.php"> <li class="nav-item active">Add Admin</li></a>
    ...
    <div class="container1">
        <form class="member-form" method="post" action="blogstore.php" enctype="multipart/form-data">
            <div class="form-group">
                <label for="blogImage">Blog Image:</label>
                <input type="file" style="border: 2px brown solid; width:500px;" id="blogImage" name="blogimage" accept="image/*" required>
            </div>
            <div class="form-group">
                <label for="winnername">Winner Name:</label>
                <input type="text" style="border: 2px brown solid; width:500px;" id="winnername" name="winnername" required>
            </div>
            <div class="form-group">
                <label for="competitionname">Competition Name:</label>
                <input type="text" style="border: 2px brown solid; width:500px;" id="competitionname" name="competitionname" required>
            </div>
            <div class="form-group">
                <label for="dat">Date:</label>
                <input type="date" style="border: 2px brown solid; width:500px;" id="dat" name="dat" required>
            </div>
...
<?php
  include("dbconfig.php"); // Make sure this file includes the database connection
  ...
  if (isset($_POST['submit'])) {
      ...
      $sql = "INSERT INTO adminlogindata (Username, Password) VALUES (?, ?)";
