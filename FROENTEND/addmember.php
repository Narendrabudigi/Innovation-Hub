...
@media screen and (max-width: 768px) {
	...
	<body>
		...
		<!-- End Header/Navigation -->
            ...
            <form class="member-form" method="post" action="memberstore.php"enctype="multipart/form-data" >
    <div class="form-group">
        <label for="memberImage">Member Image:</label>
        <input type="file" style="border: 2px brown solid;width:500px;"id="memberImage" name="memberImage" accept="image/*" required>
    </div>
    <div class="form-group">
        <label for="memberName">Name:</label>
        <input type="text" style="border: 2px brown solid;width:500px;"id="memberName" name="membername" required>
    </div>
	<div class="form-group">
        <label for="membeepin">PIN:</label>
        <input type="text" style="border: 2px brown solid;width:500px;"id="memberName" name="memberpin" required>
    </div>
    <div class="form-group">
        <label for="memberDescription">Description:</label>
        <textarea id="memberDescription" placeholder="why you joined"style="border: 2px brown solid;width:500px;"name="memberdescription" required></textarea>
    </div>
    <div class="form-group">
        <label for="memberEmail">Email:</label>
        <input type="email" id="memberEmail"style="border: 2px brown solid;width:500px;" name="memberemail" required>
    </div>
    <div class="form-group">
        <label for="memberPosition">Position:</label>
        <input type="text" id="memberPosition"style="border: 2px brown solid;width:500px;" name="memberposition" required>
    </div>
