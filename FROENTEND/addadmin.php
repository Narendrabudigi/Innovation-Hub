		...
		<!-- End Header/Navigation-->
			...
			<div class="slider">
				<div>
					<ul>
                        ...
                        <li class="nav-item active">Add Admin</li>
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <input type="text"  name="username" required style="border: 2px brown solid;">
                </div>
                
                <div class="form-group">
                    <label for="">password:</label>
                    <input type="text"  name="password" required style="border: 2px brown solid;">
                </div>
