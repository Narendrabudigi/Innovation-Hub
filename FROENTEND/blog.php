...
<body>
	...
	<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
		...
		<div class="container">
			<a class="navbar-brand" data-aos="flip-left" href="home.php"><img src="images/IB-logo.png"
					style="height:100px;border-radius: 50%;width:100px;"></a>
			<a class="navbar-brand" data-aos="flip-left" href="https://svgovtpolytirupathi.ac.in/"><img
					src="images/SVGP TIRUPATI LOGO.jpg" style="height:100px;border-radius: 50%;width:100px;"></a>
			...
			<div class="collapse navbar-collapse" id="navbarsFurni">
				<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
					...
					<li class="nav-item active"><a class="nav-link" data-aos="fade-left" href="blog.php">Blog</a></li>
			...
			<div class="row justify-content-between">
				<div class="col-lg-5">
					<div class="intro-excerpt">
						...
						<p data-aos="fade-right" class="mb-4"></p>

					</div>
				</div>
				<div class="col-lg-7">
					<div class="hero-img-wrap">
						<img data-aos="fade-left" src="images/grouppic.jpg" id="image-container" class="img-fluid"
							style="height:260px;width:700px;border-radius: 15px;margin-right:0px;">
					</div>
				</div>
			</div>
		</div>
	</div>
	<form class="search"method=post action="blogfilter.php">
        <img src="./images/search-icon.jpg">
        <input type="text" id="name" name="pin" placeholder="Search here with event name" required >
   ...
   $res = mysqli_query($con, "SELECT * FROM blogdata");
    if (!$res) {
	...
	<footer class="footer-section">
		<div class="container relative">
			...
			<div class="row g-5 mb-5">
				<div class="col-lg-4">
					<div data-aos="fade-right" class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">INNOVATION
							HUB</a><span>.</span></a></div>
					<p data-aos="fade-right" class="mb-4">The primary goal of developing this innovation hub is to give
						students a platform and an opportunity to showcase their creativity and innovation.
					...
					<div class="row links-wrap">
						...
						<div class="col-6 col-sm-6 col-md-3">
							<ul data-aos="fade-down" class="list-unstyled">
								...
								<li><a href="https://en.wikipedia.org/wiki/Main_Page" target="_blank">Knowledge base</a>
								</li>
			...
			<div class="border-top copyright">
				<div class="row pt-4" style="background-color: aqua;border-radius: 25px;;">
					<div class="col-lg-6">
						<p data-aos="fade-up" class="mb-2 text-center text-lg-start">Copyright &copy;
							<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash;
							Designed by <a data-aos="fade-up" href="#">INNOVATION HUB</a>
							...
							<div class="item">
								<div class="row justify-content-center">
									<div class="col-lg-8 mx-auto">
										...
										<div class="testimonial-block text-center">
											<blockquote class="mb-5">
												<p>&ldquo;Joining the Innovation Hub was a game-changer! The
													collaborative atmosphere and access to cutting-edge resources
													propelled our ideas from concept to reality. With their support, our
													team achieved milestones we never thought possible. The Innovation
													Hub isn't just a space; it's a catalyst for innovation and
													growth..&rdquo;</p>
											</blockquote>

											<div class="author-info">
												<div class="author-pic">
													<img data-aos="flip-right" src="images/mine.jpg" alt="Narendra"
														class="img-fluid">
												</div>
												<h3 data-aos="fade-left" class="font-weight-bold">Narendra </h3>
												<span data-aos="fade-left"
													class="position d-block mb-3">coodinator</span>
											</div>
										</div>
