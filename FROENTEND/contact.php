			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li class="nav-item active"><a class="nav-link" data-aos="fade-left" href="contact.php">Contact us</a></li>
						...
						<div class="col-lg-5">
							<div class="intro-excerpt">
								...
								<p data-aos="fade-right"class="mb-4">
									...
									"Innovation thrives at the intersection of collaboration and curiosity. Reach out to us and let's brighten our ideas together."</p>
									<p data-aos="fade-right"class="mb-4">

										"Let's illuminate the path to innovation together. Drop us a line and let the sparks of creativity fly!"</p>
							</div>
						</div>
						<div class="col-lg-7">
							<div class="hero-img-wrap">
								<img data-aos="fade-left"src="images/grouppic.jpg" id="image-container" class="img-fluid" style="height:430px;border-radius: 15px;width:700px;margin-right:0px;">
							</div>
						</div>
					</div>
				</div>
              ...
              <div class="row mb-5">
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p><a href="https://maps.app.goo.gl/VL1QL7oYUHeTvTXd9">SV GOVT Polytechnic,Tirupati</a></p>
                ...
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p><a href="mailto:narendrabudigi947@gmail.com">GMAIL</a></p>
                    </div> <!-- /.service-contents-->
                  </div> <!-- /.service -->
                </div>
                ...
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p><a href="tel:+918309377748">support</a></p>
                    </div> <!-- /.service-contents-->
                  </div> <!-- /.service -->
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      <label data-aos="fade-down"class="text-black" for="fname">First name</label>
                      <input data-aos="fade-down"type="text" name="firstname"class="form-control" id="fname" style="border: 2px brown solid;">
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="form-group">
                      <label data-aos="fade-down"class="text-black" for="lname">Last name</label>
                      <input data-aos="fade-down"type="text" name="lastname"class="form-control" id="lname" style="border: 2px brown solid;">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label data-aos="fade-down"class="text-black" for="email">Email address</label>
                  <input data-aos="fade-down"type="email" name="email"class="form-control" id="email" style="border: 2px brown solid;">
                </div>

                <div class="form-group mb-5">
                  <label data-aos="fade-down"class="text-black" for="message">Message</label>
                  <textarea data-aos="fade-down"name="message" class="form-control" id="message" cols="30" rows="5" style="border: 2px brown solid;"></textarea>
                </div>

                <button data-aos="fade-down"type="submit" class="btn btn-primary-hover-outline" onclick="function1()">Send Message</button>
              </form>
